...
.equ SZ_ST_TIMER 						= 6
.equ ST_TIMER_COUNTER_CONTROL_REGISTER_ADDRESS_OFFSET		= 0
.equ ST_TIMER_DIVIDER_BIT_MASK_OFFSET				= 2
.equ ST_TIMER_INTERRUPT_BIT_MASK_OFFSET				= 3
.equ ST_TIMER_OVERFLOW_HANDLER_OFFSET				= 4
