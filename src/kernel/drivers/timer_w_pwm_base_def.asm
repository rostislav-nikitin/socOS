; size
.equ SZ_ST_TIMER_W_PWM_BASE 						= SZ_ST_TIMER_BASE + 0x07
...
.equ ST_TIMER_W_PWM_BASE_MODE_OFFSET					= SZ_ST_TIMER_BASE + 0x02
.equ ST_TIMER_W_PWM_BASE_COMPARE_THRESHOLD_OFFSET			= SZ_ST_TIMER_BASE + 0x03
.equ ST_TIMER_W_PWM_BASE_COMPARE_INTERRUPT_BIT_MASK_OFFSET		= SZ_ST_TIMER_BASE + 0x04
.equ ST_TIMER_W_PWM_BASE_COMPARE_HANDLER_OFFSET				= SZ_ST_TIMER_BASE + 0x05
...
.equ TIMER_W_PWM_MODE_PHASE_CORRECTION		= 0x01
.equ TIMER_W_PWM_MODE_PHASE_CORRECTION_INVERTED	= 0x02
.equ TIMER_W_PWM_MODE_FAST			= 0x03
.equ TIMER_W_PWM_MODE_FAST_INVERTED		= 0x04
