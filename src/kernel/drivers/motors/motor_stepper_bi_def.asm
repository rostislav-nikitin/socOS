...
; ST_MOTOR_STEPPER_BI_CURRENT_WAIT_STEP
.equ ST_MOTOR_STEPPER_BI_CURRENT_WAIT_STEP_DEFAULT = 0x00

; ST_MOTOR_STEPPER_BI_CURRENT_STEP
.equ ST_MOTOR_STEPPER_BI_CURRENT_STEP_STOP		= 0x00
.equ ST_MOTOR_STEPPER_BI_CURRENT_STEP_DEFAULT	= ST_MOTOR_STEPPER_BI_CURRENT_STEP_STOP
.equ ST_MOTOR_STEPPER_BI_CURRENT_STEP_INFINITY	= 0x80; -1