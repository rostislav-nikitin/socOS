...
.equ ST_BUTTON_ON_BUTTON_DOWN_HANDLER		= SZ_ST_IN_BIT + 1
.equ ST_BUTTON_ON_BUTTON_UP_HANDLER		= SZ_ST_IN_BIT + 3
.equ ST_BUTTON_ON_BUTTON_PRESSED_HANDLER	= SZ_ST_IN_BIT + 5
